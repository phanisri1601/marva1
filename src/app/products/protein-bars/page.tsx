...
const proteinBars = [
  {
    ...
    features: ['Plant Based Protein', '10g Protein', '40g Net Weight', 'High Energy', '₹49'],
    badge: 'Bestseller',
  ...
  },
  {
    ...
    fiber: '80g',
    calories: '350-370',
    description: 'Traditional style katora with wholesome ingredients and authentic flavors.',
    ingredients: 'Whey Protein, Oats, Honey, Dates, Mixed Nuts, Cardamom',
    features: ['Traditional Recipe', '80g Fibre', '350-370 Calories', 'Natural Energy', '₹69'],
    badge: 'New',
    image: '/katora.jpeg'
  },
  {
